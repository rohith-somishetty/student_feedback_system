...
CREATE TABLE IF NOT EXISTS issues (
  ...
  status TEXT NOT NULL DEFAULT 'OPEN' CHECK (status IN ('OPEN', 'IN_REVIEW', 'RESOLVED', 'CONTESTED', 'REOPENED', 'ESCALATED')),
...
CREATE TABLE IF NOT EXISTS timeline_events (
  ...
  type TEXT NOT NULL CHECK (type IN ('CREATED', 'STATUS_CHANGE', 'EVIDENCE_UPLOAD', 'CONTEST', 'ADMIN_UPDATE', 'SUPPORT')),
